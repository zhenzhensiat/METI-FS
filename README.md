...
Measurements were performed on a workstation with 12 CPU cores and 32 GB RAM
(R 4.5.2, Windows x86_64). Actual runtime will vary with hardware; the numbers
above should be treated as representative estimates.
...
- **Peak memory** occurs during DESeq2 normalization or WGCNA adjacency
  matrix construction.
